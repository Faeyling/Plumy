export const fr = {
  ...
  onboarding: {
    ...
    ecranPagesTitre: "L'appli en un coup d'œil",
    ecranPagesTexte: "Unités pour apprendre, Quiz pour t'entraîner, Révision pour consolider, Parcours pour explorer les thèmes transversaux entre disciplines, et Graphe pour voir toutes les connexions.",
    ecranPointsTitre: "Les points, c'est simple",
    ecranPointsTexte: "10 pts par bonne réponse. Enchaîne les succès pour un combo : ×1,5 dès 3 d'affilée, ×2 dès 5, ×3 dès 10. Et si tu lis un cours avant le quiz, tu gagnes +50 % en bonus !",
    ecran2Titre: "Navigue à ton rythme",
    ecran2Texte: "Explore les unités dans l'ordre qui te plaît. Quand un terme te parle, mets-lui une ★ — je l'ajouterai à ton carnet de favoris pour que tu le retrouves facilement.",
    ecranRgpdTitre: "Tes données t'appartiennent",
    ecranRgpdTexte: "Aucun compte, aucune collecte — tout reste sur ton appareil. Exporte régulièrement pour ne rien perdre si tu changes d'appareil. Des questions ? Contacte Faëyling, ma créatrice.",
